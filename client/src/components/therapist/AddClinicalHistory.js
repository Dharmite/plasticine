...
import { getPatient, addClinicalHistory } from '../../actions/patientActions';
import $ from 'jquery';
...
class AddClinicalHistory extends Component {
    ...
    onSubmit = (e) => {
        ...
        if (availableTo2 !== '') {
            ...
            this.props.addClinicalHistory(id, formData, this.props.history);
                                ...
                                <div className='modal-dialog' role='document'>
                                    <div className='modal-content'>
                                        ...
                                        <div className='modal-body'>
                                            Deseja mesmo partilhar com estes
                                            utilizadores?
                                        </div>
...
AddClinicalHistory.propTypes = {
    addClinicalHistory: PropTypes.func.isRequired,
};
...
export default connect(mapStateToProps, { getPatient, addClinicalHistory })(
    AddClinicalHistory
);
