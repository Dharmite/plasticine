...
class EditTherapeuticNote extends Component {
    ...
    componentWillReceiveProps(nextProps, nextState) {
        const { title, activity, behavior, observation, files, filename } =
            nextProps.note;
    ...
    onSubmit = (e) => {
        ...
        const { title, observation, activity, behavior, availableTo2 } =
            this.state;
    ...
    render() {
        const { title, observation, activity, behavior, errors, filename } =
            this.state;
                                ...
                                <div class='modal-dialog' role='document'>
                                    <div class='modal-content'>
                                        ...
                                        <div class='modal-footer'>
                                            ...
                                            <Link
                                                to={`/paciente/ver/${this.props.match.params.patient_id}`}
