...
class AddTherapist extends Component {
    ...
    onSubmit = (e) => {
        ...
        const { name, email, password, specialty, password2, other } =
            this.state;
    ...
    render() {
        const { name, email, password, password2, specialty, other, errors } =
            this.state;
...
export default connect(mapStateToProps, { addTherapist })(AddTherapist);
