            ...
            filtered_patients = patient.filter((patient) => {
                return (
                    patient.name
                        .toLowerCase()
                        .indexOf(
                            this.state.patient_search.toLocaleLowerCase()
                        ) !== -1
                );
            });
        }
            ...
            filtered_previousPatients = previousPatients.filter((patient) => {
                return (
                    patient.name
                        .toLowerCase()
                        .indexOf(
                            this.state.previousPatients_search.toLocaleLowerCase()
                        ) !== -1
                );
            });
        }
                                    ...
                                    <div className='col-md-6 pr-3'>
                                        <div class='form-group'>
                                            <input
                                                ...
                                                value={
                                                    this.state.patient_search
                                                }
                                                onChange={this.updateSearch.bind(
                                                    this
                                                )}
                                                class='form-control'
                                            />{' '}
                                    ...
                                    <div className='col-md-6 pr-3'>
                                        <div class='form-group'>
                                            <input
                                                ...
                                                onChange={this.updateSearchPrevious.bind(
                                                    this
                                                )}
                                                class='form-control'
                                            />{' '}
...
export default connect(mapStateToProps, { getTherapist })(DashboardTherapist);
