...
class EditTherapist extends Component {
    ...
    componentWillReceiveProps(nextProps, nextState) {
        const { name, email, specialty, account_status, other } =
            nextProps.therapist;
    ...
    onSubmit = (e) => {
        ...
        if (newTherapist.specialty === '0') {
            ...
            this.setState({
                errors: {
                    specialty:
                        'Este campo tem que ser preenchido com um valor válido',
                },
            });
            return;
        }
    ...
    render() {
        const { name, email, specialty, errors, account_status, other } =
            this.state;
...
export default connect(mapStateToProps, { getTherapist, updateTherapist })(
    EditTherapist
);
