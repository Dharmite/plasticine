...
import { removeClinicalHistory } from '../../actions/patientActions';
...
class ClinicalHistory extends Component {
    onClickRemoveResource = (resource_id) => {
        this.props.removeClinicalHistory(resource_id);
    };
    render() {
        const {
            _id,
                                        ...
                                        <div className='row'>
                                            <div className='description-block mr-3'>
                                                <Link
                                                    ...
                                                    to={`/paciente/${patient}/avaliação/${_id}`}
                                                >
                                                    Detalhes
                                                </Link>
                                            </div>
                                                    ...
                                                    user._id ? (
                                                        <div className='description-block mr-3'>
                                                            <Link
                                                                ...
                                                                to={`/paciente/${patient}/avaliação/${_id}/editar`}
                                                            >
                                                                Editar
                                                            </Link>
                                                        </div>
...
export default connect(mapStateToProps, { removeClinicalHistory })(
    ClinicalHistory
);
