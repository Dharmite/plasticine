          ...
          <ul className="nav nav-tabs" id="myTab" role="tablist">
            <li className="nav-item">
              ...
              >
                ...
                {this.props.desenvolvimento_verbal ? (
                  <small className="text-muted">{compreensao.length}</small>
                ) : null}
                )
              </a>
            </li>
            <li className="nav-item">
              ...
              >
                Raciocínio Verbal (
                {this.props.desenvolvimento_verbal ? (
                  <small className="text-muted">{raciocinio.length}</small>
                ) : null}
                ){" "}
              </a>
            </li>
            <li className="nav-item">
              ...
              >
                ...
                {this.props.desenvolvimento_verbal ? (
                  <small className="text-muted">{consciencia.length}</small>
                ) : null}
                ){" "}
              </a>
            </li>
            <li className="nav-item">
              ...
              >
                ...
                {this.props.desenvolvimento_verbal ? (
                  <small className="text-muted">{segmentacao.length}</small>
                ) : null}
                ){" "}
              </a>
            </li>
            <li className="nav-item">
              ...
              >
                Fluência Verbal (
                {this.props.desenvolvimento_verbal ? (
                  <small className="text-muted">{fluencia.length}</small>
                ) : null}
                ){" "}
              </a>
            </li>
