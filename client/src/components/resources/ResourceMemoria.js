    ...
    render() {
        ...
        if (this.props.memoria) {
            numerica_repetitiva = this.props.memoria.filter(
                (resource) =>
                    resource.subCategory === 'Verbal e Numérica Repetitiva'
            );
        }
        if (this.props.memoria) {
            numerica_significativa = this.props.memoria.filter(
                (resource) =>
                    resource.subCategory === 'Verbal e Numérica Significativa'
            );
        }
