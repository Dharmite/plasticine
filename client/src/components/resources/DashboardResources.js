...
class DashboardResources extends Component {
    ...
    render() {
        ...
        let desenvolvimento_verbal_resources_all =
        ...
        desenvolvimento_verbal_resources =
            desenvolvimento_verbal_resources.slice(0, 3);
                                ...
                                <div class='container'>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {percepcao_resources ? (
                                                percepcao_resources.length >
                                                0 ? null : (
                                                    <h6 className='mt-4'>
                                                        Sem recursos desta área
                                                    </h6>
                                                )
                                            ) : null}

                                            {percepcao_resources ? (
                                                percepcao_resources_all.length >
                                                3 ? (
                                                    <button
                                                        className='btn'
                                                        style={{
                                        ...
                                        >
                                            ...
                                            {motricidade_resources ? (
                                                motricidade_resources_all.length >
                                                3 ? (
                                                    <button
                                                        className='btn'
                                                        style={{
                                        ...
                                        >
                                            {desenvolvimento_verbal_resources
                                                ? desenvolvimento_verbal_resources.map(
                                                      (resource) => (
                                                          <Resource
                                                              key={resource._id}
                                                              resource={
                                                ...
                                                : null}
                                            {desenvolvimento_verbal_resources ? (
                                                desenvolvimento_verbal_resources.length >
                                                0 ? null : (
                                                    <h6 className='mt-4'>
                                                        Sem recursos desta área
                                                    </h6>
                                            ...
                                            {desenvolvimento_verbal_resources ? (
                                                desenvolvimento_verbal_resources_all.length >
                                                3 ? (
                                                    <button
                                                        className='btn'
                                                        style={{
                                        ...
                                        >
                                            ...
                                            {areas_numericas_resources ? (
                                                areas_numericas_resources_all.length >
                                                3 ? (
                                                    <button
                                                        className='btn'
                                                        style={{
                                            ...
                                            {areas_numericas_resources ? (
                                                areas_numericas_resources.length >
                                                0 ? null : (
                                                    <h6 className='mt-4'>
                                                        Sem recursos desta área
                                                    </h6>
                                        ...
                                        >
                                            {emocional_social_resources
                                                ? emocional_social_resources.map(
                                                      (resource) => (
                                                          <Resource
                                                              key={resource._id}
                                                              resource={
                                            ...
                                            {emocional_social_resources ? (
                                                emocional_social_resources.length >
                                                0 ? null : (
                                                    <h6 className='mt-4'>
                                                        Sem recursos desta área
                                                    </h6>
                                            ...
                                            {emocional_social_resources ? (
                                                emocional_social_resources_all.length >
                                                3 ? (
                                                    <button
                                                        className='btn'
                                                        style={{
...
export default connect(mapStateToProps, { getResourceByCategory })(
    DashboardResources
);
