    ...
    render() {
        ...
        if (this.props.avd) {
            hospital_centro = this.props.avd.filter(
                (resource) =>
                    resource.subCategory === 'Hospital / Centro Médico'
            );
        }
...
export default connect(mapStateToProps, { getResourceByCategory })(ResourceAVD);
