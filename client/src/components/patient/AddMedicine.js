...
class AddMedicine extends Component {
    ...
    onSubmit = (e) => {
        ...
        const { name, observation, dosage, time, startingDate, finishedDate } =
            this.state;
                            ...
                            <div className='card mb-3 mt-4'>
                                ...
                                <div className='card-body'>
                                    <form onSubmit={this.onSubmit}>
                                        ...
                                        <input
                                            type='submit'
                                            value='Adicionar terapêutica farmacológica'
...
export default connect(mapStateToProps, { addMedicine })(AddMedicine);
