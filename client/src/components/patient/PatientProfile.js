...
class PatientProfile extends Component {
    ...
    onSubmitTherapist = (e) => {
        ...
        if (
            ...
            axios
                .get(
                    `/api/users/therapist/name/${this.state.selectedTherapist}`
                )
                .then((res) => {
                                            ...
                                            <div className='modal-content'>
                                                ...
                                                <div className='modal-body'>
                                                    ...
                                                    <span className='mr-2 ml-2'>
                                                        Guardar este utilizador
                                                        no historial da criança
                                                    </span>
                                                </div>
                                                <div className='modal-footer'>
                                                    <button
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <select
                                                                    ...
                                                                    onChange={
                                                                        this
                                                                            .handleTherapistSelectionChanged
                                                                    }
                                                                >
                                                                    <option id='option'>
                                                                        Escolha
                                                                                                                ...
                                                                                                                <div className='row'>
                                                                                                                    ...
                                                                                                                    <div className='description-block mr-3'>
                                                                                                                        <Link
                                                                                                                            ...
                                                                                                                            to={`/paciente/${_id}/ver/medicamento/editar/${elem._id}`}
                                                                                                                        >
                                                                                                                            Editar
                                                                                                                        </Link>
                                                                                                                    </div>
                                                            ...
                                                            <div class='card'>
                                                                ...
                                                                <div className='card-body p-0'>
                                                                    <ul className='products-list product-list-in-card pl-2 pr-2'>
                                                                        {patientTherapists.length >
                                                                        0 ? (
                                                                            patientTherapists.map(
                                                                                (
                                                                                    elem
                                                                                ) => (
                                                                                    <li className='item'>
                                        ...
                                        <div className='error-page'>
                                            ...
                                            <div className='error-content'>
                                                <h3>
                                                    ...
                                                    Oops! Não tem autorização
                                                    para visualizar esta pagina.
                                                </h3>
                                                <p>
                                                    Precisa de estar associado a
                                                    este paciente para poder
